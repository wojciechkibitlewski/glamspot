<div class="w-full flex flex-col md:flex-row justify-between py-8 gap-8 md:gap-1">
    ...
    <div class="w-full">
        <nav class="flex flex-col gap-2">
            ...
            {{-- 
            <a href="{{ route('advertisement') }}" title="{{ __('footer.wszystkie_title') }}" class="">{{ __('footer.wszystkie') }}</a>
            <a href="{{ route('advertisement.category', 'praca') }}" title="{{ __('footer.praca_title') }}" class="">{{ __('footer.praca') }}</a>
            <a href="{{ route('advertisement.category', 'urzadzenia-i-sprzet') }}" title="{{ __('footer.sprzet_urzadzenia_title') }}" class="">{{ __('footer.sprzet_urzadzenia') }}</a>
            <a href="{{ route('advertisement.category', 'szkolenia') }}" title="{{ __('footer.szkolenia_title') }}" class="">{{ __('footer.szkolenia') }}</a>
            <a href="{{ route('advertisement.category', 'inne') }}" title="{{ __('footer.inne_title') }}" class="">{{ __('footer.inne') }}</a>
             --}}
        </nav>
    </div>
