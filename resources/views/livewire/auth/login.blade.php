                ...
                <form method="POST" wire:submit="login" class="flex flex-col gap-6 mt-6 font-light">
                    ...
                    <div class="relative">
                        ...
                        @if (Route::has('password.request'))
                            <flux:link class="absolute top-0 text-sm end-0 text-zinc-800 dark:text-zinc-900!" :href="route('password.request')" wire:navigate>
                    ...
                    <div class="flex items-center justify-end">
                        <button data-test="login-button" type="submit" class="w-full px-8 py-4 rounded-full bg-gradient-to-r from-[#BA75EC] to-[#1FC2D7] text-white font-medium text-body-medium-m hover:opacity-90 transition cursor-pointer">
                            {{ __('auth.login') }}
                        </button>
                    ...
                    <div class="space-x-1 rtl:space-x-reverse text-left text-sm text-zinc-600 dark:text-zinc-400">
                        ...
                        <flux:link :href="route('register')" wire:navigate class="text-zinc-800 dark:text-zinc-900!">{{ __('auth.register') }}</flux:link>
                    </div>
                </form>            
            </div>
        </div>
        <div class="w-full flex items-center justify-center rounded-xl aspect-square bg-linear-to-bl from-[#E446B4] to-[#6A80CE] ">
